"""
Django settings for gsrec_project project.
...
ROOT_URLCONF = 'gsrec_project.urls'
...
WSGI_APPLICATION = 'gsrec_project.wsgi.application'
...
# Grappelli Settings
GRAPPELLI_ADMIN_TITLE = 'GSREC Admin'
